...
from common import (
    SmallCNN, configure_determinism, environment_metrics, environment_parameters,
...
def main():
    ...
    p.add_argument("--output", default="cnn_replication.csv")
    args = p.parse_args()

    configure_determinism(1)
    batch_size, epochs, k, q, lr = 128, 10, 16, 4, 5e-3
